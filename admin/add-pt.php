    ...
    <div class=" content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Add Pay Slip</h4>
                    ...
                    <div class="panel-body">
                        <form method="post" action="./create_pt.php">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="SLTra" autocomplete="off" required />
                            </div> 
                            <div class="form-group">
                            ...
                            <button class="btn btn-info">Add Pay Slip</button>
