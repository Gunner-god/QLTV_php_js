            ...
            <div class="row pad-botm" style="padding: 40px 40px 40px 40px">
                ...
                <table class="table table-striped">
                    ...
                    <tbody id="myTable">
                        <?php foreach ($data as $repository) : ?>
                            <tr>
                                <td><?= htmlspecialchars($repository["MaTheLoai"]) ?></td>
                                <td><?= htmlspecialchars($repository["TenTL"]) ?></td>
                                <th><a href="./delete-TL.php?MaTheLoai=<?= $repository["MaTheLoai"] ?>">Delete</a></th>
                            </tr>
                        <?php endforeach; ?>
                ...
                <th>
                    <button class="btn  btn-danger" style="font-size: 15px;
                        ...
                        transition: all .3s;">
                        <a href="./add_TL.php">New Categories</a>
                    </button>
                </th>
            </div>
        </div>
